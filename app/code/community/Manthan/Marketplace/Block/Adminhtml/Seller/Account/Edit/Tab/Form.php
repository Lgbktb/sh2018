...
class Manthan_Marketplace_Block_Adminhtml_Seller_Account_Edit_Tab_Form extends Mage_Adminhtml_Block_Widget_Form {
       ...
       $fieldset = $form->addFieldset('shop_fieldset', array('legend'=>Mage::helper('adminhtml')->__('Shop Information')));
			...
			$other_fieldset->addField('account_holder_name', 'text', array(
					...
					'required' => false,
					'value' => $sellerModel->getAccountHolderName()
				)
			);
			...
			$other_fieldset->addField('account_number', 'text', array(
					...
					'required' => false,
					'value' => $sellerModel->getAccountNumber()
				)
			);
			...
			$other_fieldset->addField('bank_branch', 'text', array(
					...
					'required' => false,
					'value' => $sellerModel->getBankBranch()
				)
			);
