				...
				$dir_path = Mage::getBaseDir('media') . DS . 'marketplace' . DS . 'seller' . DS . 'images' . DS;
					...
					{	
						...
						$seller->setShopName($this->getRequest()->getParam('shop_name'))
							...
							->setUserId($userId)
							->setBankName($this->getRequest()->getParam('bank_name'))
							->setAccountHolderName($this->getRequest()->getParam('account_holder_name'))
							->setAccountNumber($this->getRequest()->getParam('account_number'))
							->setBankBranch($this->getRequest()->getParam('bank_branch'))
							->setIfscCode($this->getRequest()->getParam('ifsc_code'))
							->save();
						}
					}
